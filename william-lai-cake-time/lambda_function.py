...
#-----------------------------------------------------------------------------------------------------#
#   The import statement below was close but not quite right. You had written:
#
#           from ask_sdk_core.utils import getSupportedInterfaces
#
#   ...but that's the name of the Node.JS module. The Python module uses underscores in the name:
#
#           from ask_sdk_core.utils import get_supported_interfaces
#
#   I've corrected the import statement for you (see Line #33 below).
#-----------------------------------------------------------------------------------------------------#
from ask_sdk_core.utils import get_supported_interfaces
...
#-----------------------------------------------------------------------------------------------------#
#   The 'import json' statement was missing, which prevented the _load_apl_document()
#   function from working properly. I've added it for you (see Line #41 below).
#-----------------------------------------------------------------------------------------------------#
import json
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        ...
        #-----------------------------------------------------------------------------------------------------#
        #   This block of code you have for adding the APL display template to the
        #   handler_input_response_builder object is written in Node.JS
        #
        #   ...wrong tutorial and programming language...
        #
        #   To fix this, I commented out the Node.JS version and replaced it with the Python version below.
        #-----------------------------------------------------------------------------------------------------#
